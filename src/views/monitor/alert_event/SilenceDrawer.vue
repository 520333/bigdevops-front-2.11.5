  ...
  <BasicDrawer v-bind="$attrs" @register="registerDrawer" showFooter :title="getTitle" width="30%" @ok="handleSubmit">
    <BasicForm @register="registerForm">
      <template #relabelSlot="{ model, field }">
        <CodeEditor v-if="renderEditor" v-model:value="model[field]" mode="yaml" :readonly="false"
          style="height: 250px;" :options="{ smartIndent: false, tabSize: 2, indentWithTabs: false }"
